...
class Gridworld_CL(object):
    ...
    def reset(self):
        ...
        return self.curr_state, self.action_mask, change_flag
...
if __name__=="__main__":
    # Random Agent
    rewards_list = []
    env = Gridworld_CL(debug=True, n_actions=10, change_interval=-1, change_count=3, max_episodes=100)
    for i in range(1000):
        rewards = 0
        done = False
